  ...
  return (
    <nav className='container px-4 pt-10 mx-auto font-bold'>
        <div className='flex justify-between items-center'>
            <div className='p-4'><Link to="/" className='text-xl'>Suap</Link></div>
            <div className=''>
                <ul className='md:flex hidden p-4 items-center'>
                    <li className='mr-20 font-black text-xl'>United kingdom</li>
                    <li className='mx-6 font-black text-xl'>Sustainabiity</li>
                    <li className='mx-6 font-black text-xl'>Blog</li>
                    <li className='mx-6 font-black text-xl'>
